...
*/
#define AGNENTROPROX_BUILD_BREAK_COUNT (1+FRU128_BUILD_BREAK_COUNT+FRU64_BUILD_BREAK_COUNT+LOGGAMMA_BUILD_BREAK_COUNT)
#define AGNENTROPROX_BUILD_BREAK_COUNT_EXPECTED 7
...
*/
#define AGNENTROPROX_BUILD_FEATURE_COUNT (5+FRU128_BUILD_FEATURE_COUNT+FRU64_BUILD_FEATURE_COUNT+LOGGAMMA_BUILD_FEATURE_COUNT)
/*
...
*/
#define AGNENTROPROX_BUILD_ID (10+FRU128_BUILD_ID+FRU64_BUILD_ID+LOGGAMMA_BUILD_ID)
