...
main(int argc, char *argv[]){
  ...
  do{
    ...
    if(argc!=6){
      ...
      DEBUG_PRINT("(output) is the folder, corresponding to but different from (input), to which\nto write the corresponding output masks in files of identical names.\n\n");
      break;
    }
    arg_idx=0;
    do{
