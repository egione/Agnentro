...
extern u8 loggamma_from_u64(fru128 *a_base, loggamma_t *loggamma_base, u64 v);
extern fru128 *loggamma_from_u64_cache_init(ULONG loggamma_idx_max_max);
extern u8 loggamma_from_u64_cached(fru128 *a_base, loggamma_t *loggamma_base, ULONG *loggamma_idx_max_base, ULONG loggamma_idx_max_max, fru128 *loggamma_list_base, u64 v);
