...
extern fru64 *fracterval_u64_log_delta_u64_cache_init(ULONG log_delta_idx_max_max);
extern u8 fracterval_u64_log_delta_u64_cached(fru64 *a_base, ULONG *log_delta_idx_max_base, ULONG log_delta_idx_max_max, fru64 *log_delta_list_base, u64 v);
...
extern fru64 *fracterval_u64_log_u64_cache_init(ULONG log_idx_max_max);
extern u8 fracterval_u64_log_u64_cached(fru64 *a_base, ULONG *log_idx_max_base, ULONG log_idx_max_max, fru64 *log_list_base, u64 v);
