...
extern fru128 *fracterval_u128_log_delta_u64_cache_init(ULONG log_delta_idx_max_max);
extern u8 fracterval_u128_log_delta_u64_cached(fru128 *a_base, ULONG *log_delta_idx_max_base, ULONG log_delta_idx_max_max, fru128 *log_delta_list_base, u64 v);
...
extern fru128 *fracterval_u128_log_u64_cache_init(ULONG log_idx_max_max);
extern u8 fracterval_u128_log_u64_cached(fru128 *a_base, ULONG *log_idx_max_base, ULONG log_idx_max_max, fru128 *log_list_base, u64 v);
...
extern u8 fractoid_u128_ratio_u128_saturate(u128 *a_base, u128 p, u128 q);
...
extern u8 u128_multiply_u64_saturate(u128 *a, u128 p, u64 v);
