...
extern fru128 agnentroprox_coshannonism_get(agnentroprox_t *agnentroprox_base, ULONG haystack_mask_idx_max, u8 *haystack_mask_list_base, u8 *overflow_status_base);
extern ULONG agnentroprox_coshannonism_transform(agnentroprox_t *agnentroprox_base, u8 ascending_status, fru128 *coshannonism_list_base, ULONG haystack_mask_idx_max, u8 *haystack_mask_list_base, ULONG match_idx_max_max, ULONG *match_u8_idx_list_base, u8 *overflow_status_base, ULONG sweep_mask_idx_max);
...
extern ULONG agnentroprox_diventropy_transform(agnentroprox_t *agnentroprox_base, u8 ascending_status, fru128 *diventropy_list_base, ULONG haystack_mask_idx_max, u8 *haystack_mask_list_base, ULONG match_idx_max_max, ULONG *match_u8_idx_list_base, u8 *overflow_status_base, ULONG sweep_mask_idx_max);
...
extern ULONG agnentroprox_entropy_transform(agnentroprox_t *agnentroprox_base, u8 ascending_status, fru128 *entropy_list_base, ULONG mask_idx_max, u8 *mask_list_base, ULONG match_idx_max_max, ULONG *match_u8_idx_list_base, u16 mode, u8 *overflow_status_base, ULONG sweep_mask_idx_max);
extern ULONG agnentroprox_exoelasticity_transform(agnentroprox_t *agnentroprox_base, u8 ascending_status, fru128 *exoelasticity_list_base, ULONG mask_idx_max, u8 *mask_list_base, ULONG match_idx_max_max, ULONG *match_u8_idx_list_base, u8 *overflow_status_base, ULONG sweep_mask_idx_max);
extern void *agnentroprox_free(void *base);
extern agnentroprox_t *agnentroprox_free_all(agnentroprox_t *agnentroprox_base);
extern agnentroprox_t *agnentroprox_init(u32 build_break_count, u32 build_feature_count, u8 granularity, loggamma_t *loggamma_base, ULONG mask_idx_max_max, u32 mask_max, u16 mode_bitmap, ULONG needle_mask_idx_max_max, u8 overlap_status, ULONG sweep_mask_idx_max_max);
...
extern u8 agnentroprox_mask_list_deltafy(u8 channel_status, u8 delta_status, u8 granularity, ULONG mask_idx_max, u8 *mask_list_base);
