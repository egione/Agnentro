...
extern fru128 agnentroprox_entropy_delta_get(agnentroprox_t *agnentroprox_base, ULONG mask_idx_max, u8 *mask_list_base, u8 mode, u8 new_status, u8 *overflow_status_base, u8 rollback_status);
extern fru128 agnentroprox_entropy_raw_get(agnentroprox_t *agnentroprox_base, ULONG mask_idx_max, u8 *overflow_status_base);
extern ULONG agnentroprox_entropy_transform(agnentroprox_t *agnentroprox_base, u8 ascending_status, fru128 *entropy_list_base, ULONG mask_idx_max, u8 *mask_list_base, ULONG match_idx_max_max, ULONG *match_u8_idx_list_base, u8 mode, u8 *overflow_status_base, ULONG sweep_mask_idx_max);
...
extern agnentroprox_t *agnentroprox_init(u32 build_break_count, u32 build_feature_count, u8 granularity, loggamma_t *loggamma_base, ULONG mask_idx_max_max, u32 mask_max, u8 mode_bitmap, u8 overlap_status, ULONG sweep_mask_idx_max_max);
