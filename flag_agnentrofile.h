...
*/
#define AGNENTROFILE_BUILD_ID (6+AGNENTROCODEC_BUILD_ID+AGNENTROPROX_BUILD_ID+ASCII_BUILD_ID+BIGUINT_BUILD_ID+FILESYS_BUILD_ID+FRU128_BUILD_ID+FRU64_BUILD_ID+LOGGAMMA_BUILD_ID)
